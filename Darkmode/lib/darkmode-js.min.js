function box(button1){
  console.log(button1);

  var box_dark = document.querySelector('nav');
  // console.log(box_dark);
  // box.style.backgroundColor = "black";box.style.color = "white";
   var dark = "w3-sidebar w3-bar-block w3-black w3-animate-left w3-text-white w3-collapse w3-top w3-center";
   var white = "w3-sidebar w3-bar-block w3-white w3-animate-left w3-text-grey w3-collapse w3-top w3-center";
   if (box_dark.className == white){
    box_dark.className = dark;
   }else{
    box_dark.className = white;
   }
  }
